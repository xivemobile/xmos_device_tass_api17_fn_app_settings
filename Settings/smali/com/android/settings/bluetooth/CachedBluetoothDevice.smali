...
.method private connectWithoutResettingTimer(Z)V
    ...
    invoke-virtual {v4, v5, v6}, Lcom/android/settings/bluetooth/LocalBluetoothAdapter;->isHostPatchRequired(Landroid/bluetooth/BluetoothDevice;I)Z
    ...
    const-string v5, "No connection expected with current device"
    ...
    invoke-interface {v3}, Lcom/android/settings/bluetooth/LocalBluetoothProfile;->isConnectable()Z
    ...
    invoke-interface {v3, v4}, Lcom/android/settings/bluetooth/LocalBluetoothProfile;->isPreferred(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    .line 233
    invoke-direct {p0, v3}, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->connectInt(Lcom/android/settings/bluetooth/LocalBluetoothProfile;)V

    goto :goto_1

    .line 230
    :cond_4
    invoke-interface {v3}, Lcom/android/settings/bluetooth/LocalBluetoothProfile;->isAutoConnectable()Z
...
.method private updateProfiles()Z
    ...
    invoke-virtual {v2, v1, v0, v3, v4}, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->addNewProfiles([Landroid/os/ParcelUuid;[Landroid/os/ParcelUuid;Ljava/util/Collection;Ljava/util/Collection;)V
