...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 50
    iput v2, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->scroll:I
    ...
    iput-object v0, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->handler:Landroid/os/Handler;

    .line 53
    iput v1, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->dragged:I

    iput v1, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->lastX:I

    iput v1, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->lastY:I

    iput v1, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->lastTarget:I
    ...
    iput-boolean v2, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->touching:Z

    iput-boolean v2, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->isDelete:Z
    ...
    iput-object v0, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->newPositions:Ljava/util/ArrayList;

    .line 102
    new-instance v0, Lcom/android/settings/cyanogenmod/DraggableGridView$1;

    invoke-direct {v0, p0}, Lcom/android/settings/cyanogenmod/DraggableGridView$1;-><init>(Lcom/android/settings/cyanogenmod/DraggableGridView;)V

    iput-object v0, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->updateTask:Ljava/lang/Runnable;

    .line 63
    invoke-direct {p0, p1}, Lcom/android/settings/cyanogenmod/DraggableGridView;->init(Landroid/content/Context;)V
...
.method private init(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/cyanogenmod/DraggableGridView;->setChildrenDrawingOrderEnabled(Z)V

    .line 80
    invoke-virtual {p0, v1}, Lcom/android/settings/cyanogenmod/DraggableGridView;->setClipChildren(Z)V

    .line 81
    invoke-virtual {p0, v1}, Lcom/android/settings/cyanogenmod/DraggableGridView;->setClipToPadding(Z)V

    .line 82
    const/4 v0, 0x3

    iput v0, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->colCount:I
...
.method protected animateDragged()V
    ...
    iget v4, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->childWidth:I
    ...
    .line 376
    .local v13, y:I
    iget v3, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->childWidth:I
    ...
    .local v9, l:I
    iget v3, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->childHeight:I
    ...
    iget v4, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->childHeight:I
...
.method protected getColumnFromCoor(I)I
    ...
    .prologue
    .line 199
    iget v1, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->cellGap:I
    ...
    .line 201
    iget v1, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->childWidth:I
    ...
    iget v2, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->cellGap:I
...
.method protected getCoorFromIndex(I)Landroid/graphics/Point;
    ...
    iget v3, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->cellGap:I

    div-int/lit8 v3, v3, 0x2

    iget v4, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->childWidth:I

    iget v5, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->cellGap:I
    ...
    iget v4, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->cellGap:I

    div-int/lit8 v4, v4, 0x2

    iget v5, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->childHeight:I

    iget v6, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->cellGap:I
...
.method public getIndexFromCoor(II)I
    ...
    .line 189
    invoke-virtual {p0, p1}, Lcom/android/settings/cyanogenmod/DraggableGridView;->getColumnFromCoor(I)I
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings/cyanogenmod/DraggableGridView;->getRowFromCoor(I)I
...
.method protected getMaxScroll()I
    ...
    .local v1, rowCount:I
    iget v2, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->childHeight:I
...
.method protected getRowFromCoor(I)I
    ...
    .line 211
    iget v1, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->childHeight:I
...
.method protected onLayout(ZIIII)V
    ...
    .line 146
    invoke-virtual {p0, v1}, Lcom/android/settings/cyanogenmod/DraggableGridView;->getChildAt(I)Landroid/view/View;
    ...
    .line 148
    invoke-virtual {p0, v1}, Lcom/android/settings/cyanogenmod/DraggableGridView;->getCoorFromIndex(I)Landroid/graphics/Point;
...
.method protected onMeasure(II)V
    ...
    .line 158
    .local v5, width:I
    invoke-virtual {p0}, Lcom/android/settings/cyanogenmod/DraggableGridView;->getPaddingLeft()I

    move-result v6

    sub-int v6, v5, v6

    invoke-virtual {p0}, Lcom/android/settings/cyanogenmod/DraggableGridView;->getPaddingRight()I

    move-result v7

    sub-int/2addr v6, v7

    iget v7, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->colCount:I

    add-int/lit8 v7, v7, -0x1

    iget v8, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->cellGap:I
    ...
    iput v6, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->childWidth:I
    ...
    iget v6, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->childWidth:I

    iput v6, v3, Landroid/view/ViewGroup$LayoutParams;->width:I

    .line 168
    iget v6, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->childHeight:I
    ...
    invoke-virtual {p0, v4, v6, v7}, Lcom/android/settings/cyanogenmod/DraggableGridView;->measureChild(Landroid/view/View;II)V
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    .line 306
    .local v14, y:I
    iget v0, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->childWidth:I
    ...
    .local v8, l:I
    iget v0, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->childHeight:I
...
.method public setCellGap(I)V
    ...
    .prologue
    .line 94
    iput p1, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->cellGap:I
...
.method public setCellHeight(I)V
    ...
    .prologue
    .line 90
    iput p1, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->childHeight:I
...
.method public setColumnCount(I)V
    ...
    .prologue
    .line 86
    iput p1, p0, Lcom/android/settings/cyanogenmod/DraggableGridView;->colCount:I
