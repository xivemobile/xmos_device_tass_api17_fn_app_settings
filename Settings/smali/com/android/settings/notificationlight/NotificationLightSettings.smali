...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/settings/notificationlight/NotificationLightSettings$PackageAdapter;,
...
.field private mPackageAdapter:Lcom/android/settings/notificationlight/NotificationLightSettings$PackageAdapter;
...
.method static synthetic access$300(Lcom/android/settings/notificationlight/NotificationLightSettings;)Landroid/content/pm/PackageManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$500(Lcom/android/settings/notificationlight/NotificationLightSettings;Ljava/lang/String;)Ljava/lang/Object;
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method private refreshDefault()V
    ...
    iput-object v15, v0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mApplicationPrefList:Landroid/preference/PreferenceGroup;

    .line 200
    move-object/from16 v0, p0

    iget-object v15, v0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mApplicationPrefList:Landroid/preference/PreferenceGroup;
...
.method private setCustomEnabled()V
    ...
    .prologue
    .line 236
    iget-boolean v1, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mCustomEnabled:Z

    if-eqz v1, :cond_2

    iget-boolean v1, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mLightEnabled:Z
    ...
    .local v0, enabled:Z
    :goto_0
    iget-boolean v1, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mVoiceCapable:Z

    if-eqz v1, :cond_0

    .line 240
    iget-object v1, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mCallPref:Lcom/android/settings/notificationlight/ApplicationLightPreference;

    invoke-virtual {v1, v0}, Lcom/android/settings/notificationlight/ApplicationLightPreference;->setEnabled(Z)V

    .line 241
    iget-object v1, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mVoicemailPref:Lcom/android/settings/notificationlight/ApplicationLightPreference;

    invoke-virtual {v1, v0}, Lcom/android/settings/notificationlight/ApplicationLightPreference;->setEnabled(Z)V

    .line 245
    :cond_0
    iget-object v1, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mApplicationPrefList:Landroid/preference/PreferenceGroup;
    ...
    .line 247
    invoke-virtual {p0, v0}, Lcom/android/settings/notificationlight/NotificationLightSettings;->setHasOptionsMenu(Z)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 121
    new-instance v2, Lcom/android/settings/notificationlight/NotificationLightSettings$PackageAdapter;

    invoke-direct {v2, p0}, Lcom/android/settings/notificationlight/NotificationLightSettings$PackageAdapter;-><init>(Lcom/android/settings/notificationlight/NotificationLightSettings;)V

    iput-object v2, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mPackageAdapter:Lcom/android/settings/notificationlight/NotificationLightSettings$PackageAdapter;
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    iget-object v3, p0, Lcom/android/settings/notificationlight/NotificationLightSettings;->mPackageAdapter:Lcom/android/settings/notificationlight/NotificationLightSettings$PackageAdapter;
